package com.haman.aop_part5_chapter05.data.api.response.mapper

import com.haman.aop_part5_chapter05.data.api.response.RealtimeArrival
...
fun RealtimeArrival.toArrivalInformation(): ArrivalInformation =
    ArrivalInformation(
        subway = Subway.findById(subwayId!!.toInt()),
