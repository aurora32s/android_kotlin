package com.haman.aop_part5_chapter03
...
import com.haman.aop_part5_chapter03.databinding.ActivityImageListBinding
...
class ImageListActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun newIntent(activity: Activity, uriList: List<Uri>): Intent {
            return Intent(activity, ImageListActivity::class.java).apply {
