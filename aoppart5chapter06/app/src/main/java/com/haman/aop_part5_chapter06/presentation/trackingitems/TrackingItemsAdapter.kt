...
import com.haman.aop_part5_chapter06.databinding.ItemTrackingBinding
import com.haman.aop_part5_chapter06.extension.setTextColorRes
import com.haman.aop_part5_chapter06.extension.toReadableDateString
import java.util.*
    ...
    inner class ViewHolder(private val binding: ItemTrackingBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(company: ShippingCompany, information: TrackingInformation) {
            ...
            when (information.level) {
                Level.COMPLETE -> {
                    binding.levelLabelTextView.setTextColorRes(R.color.red)
